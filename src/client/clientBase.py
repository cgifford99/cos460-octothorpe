...
class OctothorpeClient(object):
    ...
    '''
    def __init__(self, sock: socket, root_path: str):
        ...
        self.input_pos: int = math.floor(self.term.height * 0.6)
    ...
    def update_screen(self) -> None:
        ...
        with self.term.hidden_cursor():
            ...
            if self.map and self.map_mask:
                temp_map: list[str] = self.build_map()
